...
flags.DEFINE_string('label_map_path', 'data_dir/pascal_label_map.pbtxt',
...
def dict_to_tf_example(data,
  ...
  if 'object' in data:
    for obj in data['object']:
      ...
      #segmented.append(int(obj['segmented']))
  ...
  example = tf.train.Example(features=tf.train.Features(feature={
      ...
      'image/object/segmented': dataset_util.int64_list_feature(segmented),
...
def main(_):
  ...
  for year in years:
    ...
    print("annotations_dir path is", annotations_dir)
